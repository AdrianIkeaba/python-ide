...
class NeutronLexer(QsciLexerCustom):
    ...
    def __init__(self, language_name, editor, theme=None, defaults: DefaultConfig = None):
        ...
        if theme is None:
            self.theme = "/Users/adrianikeaba/PycharmProjects/python-ide/src/theme.json"
        else:
            self.theme = theme
        ...
        if defaults is None:
            defaults: DefaultConfig = {"color": "#abb2bf", "paper": "#282c34", "font": ("JetBrains Mono", 14)}
